...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241004044431_MergeDevelopToFeatureCameraController")]
    partial class MergeDevelopToFeatureCameraController
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 4, 1, 44, 30, 839, DateTimeKind.Local).AddTicks(3223),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
                        ...
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 4, 1, 44, 30, 839, DateTimeKind.Local).AddTicks(3338),
                            Lastname = "owner",
                            Name = "home",
                            Password = "sA$a1234",
                            ProfilePicturePath = "path"
                        ...
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 4, 1, 44, 30, 839, DateTimeKind.Local).AddTicks(3348),
                            Lastname = "owner",
                            Name = "company",
                            Password = "sA$a1234",
                            ProfilePicturePath = "path"
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Home.Hardware", b =>
                {
                    ...
                    b.HasOne("SmartHome.BusinessLogic.Feature_Device.Sensor", "Sensor")
                        .WithMany()
