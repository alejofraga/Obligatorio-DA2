...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241025144347_AddNameToHardware")]
    partial class AddNameToHardware
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 25, 11, 43, 45, 954, DateTimeKind.Local).AddTicks(5662),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
