...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241023202138_refactorModelValidator")]
    partial class RefactorModelValidator
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 23, 17, 21, 37, 244, DateTimeKind.Local).AddTicks(4388),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
