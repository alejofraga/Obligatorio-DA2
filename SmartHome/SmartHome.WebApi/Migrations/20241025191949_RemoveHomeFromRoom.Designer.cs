...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241025191949_RemoveHomeFromRoom")]
    partial class RemoveHomeFromRoom
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 25, 16, 19, 48, 234, DateTimeKind.Local).AddTicks(9504),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
