...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241023164737_validatorInclusion")]
    partial class ValidatorInclusion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 23, 13, 47, 36, 312, DateTimeKind.Local).AddTicks(3483),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
