...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241025150408_refactorDeviceHierarchy")]
    partial class RefactorDeviceHierarchy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 25, 12, 4, 7, 619, DateTimeKind.Local).AddTicks(37),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
