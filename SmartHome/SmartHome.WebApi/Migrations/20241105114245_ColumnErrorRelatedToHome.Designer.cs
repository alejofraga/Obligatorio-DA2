...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241105114245_ColumnErrorRelatedToHome")]
    partial class ColumnErrorRelatedToHome
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 11, 5, 8, 42, 44, 539, DateTimeKind.Local).AddTicks(8824),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
