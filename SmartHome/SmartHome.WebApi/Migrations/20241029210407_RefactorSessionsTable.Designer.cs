...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241029210407_RefactorSessionsTable")]
    partial class RefactorSessionsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 29, 18, 4, 5, 789, DateTimeKind.Local).AddTicks(3403),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
