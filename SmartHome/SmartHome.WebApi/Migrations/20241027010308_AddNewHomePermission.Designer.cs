...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241027010308_AddNewHomePermission")]
    partial class AddNewHomePermission
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 26, 22, 3, 7, 330, DateTimeKind.Local).AddTicks(8085),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
