...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241026220315_updatedSeedDataWithNewDeviceTypes")]
    partial class UpdatedSeedDataWithNewDeviceTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 26, 19, 3, 15, 404, DateTimeKind.Local).AddTicks(9340),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
