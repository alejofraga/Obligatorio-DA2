...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241030013958_RemoveUselessCascadeDeleting")]
    partial class RemoveUselessCascadeDeleting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 29, 22, 39, 58, 2, DateTimeKind.Local).AddTicks(2241),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
