...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241024232817_refactorDiscriminator")]
    partial class RefactorDiscriminator
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 24, 20, 28, 13, 891, DateTimeKind.Local).AddTicks(5419),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
