...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241107215315_RenameSensorModelNumberToDeviceModelNumber")]
    partial class RenameSensorModelNumberToDeviceModelNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Home.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Session.Session", b =>
                {
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 11, 7, 18, 53, 14, 405, DateTimeKind.Local).AddTicks(582),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Home.SensorHardware", b =>
                {
                    b.HasBaseType("SmartHome.BusinessLogic.Feature_Home.Hardware");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Home.Hardware", b =>
                {
                    ...
                    b.HasOne("SmartHome.BusinessLogic.Feature_Home.Room", null)
                        .WithMany("Hardwares")
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Session.Session", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Feature_User.User", "User")
                        .WithOne("Session")
                        .HasForeignKey("SmartHome.BusinessLogic.Feature_Session.Session", "UserEmail");
