...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241025182544_refactorSensorHardware")]
    partial class RefactorSensorHardware
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 25, 15, 25, 43, 161, DateTimeKind.Local).AddTicks(9360),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
