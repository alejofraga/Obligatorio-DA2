...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241025011316_lampHardware")]
    partial class LampHardware
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 24, 22, 13, 15, 249, DateTimeKind.Local).AddTicks(3119),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Device.Lamp", b =>
                {
                    b.HasBaseType("SmartHome.BusinessLogic.Feature_Device.Device");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_Device.MovementSensor", b =>
                {
                    b.HasBaseType("SmartHome.BusinessLogic.Feature_Device.Device");

                    b.HasDiscriminator().HasValue("MovementSensor");
                });
