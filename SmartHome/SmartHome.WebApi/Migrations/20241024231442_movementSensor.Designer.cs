...
namespace SmartHome.WebApi.Migrations
{
    ...
    [Migration("20241024231442_movementSensor")]
    partial class MovementSensor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Feature_User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCreation = new DateTime(2024, 10, 24, 20, 14, 41, 439, DateTimeKind.Local).AddTicks(9593),
                            Lastname = "Admin",
                            Name = "System",
                            Password = "sA$a1234",
