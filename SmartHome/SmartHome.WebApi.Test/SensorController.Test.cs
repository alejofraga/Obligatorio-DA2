...
[TestClass]
public class SensorController_Test
{
    ...
    public void OnInitialize()
    {
        ...
        _sensorController = new SensorController(_deviceService.Object);
    }
    ...
    [TestMethod]
    public void CreateSensor_WhenAllFieldsAreValid_ShouldReturnOk()
    {
        var createSensorRequest = GetValidCreateBasicDeviceRequest();
        var newDevice = GetValidDevice(createSensorRequest);
        ...
        var result = _sensorController.CreateSensor(createSensorRequest);
